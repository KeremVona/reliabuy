...
- Name: properties/user-dashboards.spec.ts >> User Dashboards (My Listings & Saved Properties) >> TC-FUNC-MYSAVED-001: Authenticated user retrieves only their favorited properties
- Location: tests/e2e/properties/user-dashboards.spec.ts:119:7
